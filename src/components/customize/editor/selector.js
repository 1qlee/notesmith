...
const enclosures = function (areaInSvgCoordinate, bbox) {
...
export const getEnclosures = function (svg, referenceElement, areaInSvgCoordinate, areaInInitialSvgCoordinate) {
