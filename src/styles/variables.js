...
const colors = {
  ...
  shadow: {
    ...
    layeredSmall: "0px -1px 1px rgba(0,0,0,0.07), 0 2px 2px rgba(0,0,0,0.03), 0 4px 4px rgba(0,0,0,0.06), 0 8px 8px rgba(0,0,0,0.07)",
    layered: "0 -1px 2px rgba(0,0,0,0.07), 0 4px 4px rgba(0,0,0,0.03), 0 8px 8px rgba(0,0,0,0.06), 0 16px 16px rgba(0,0,0,0.07)",
    layeredLarge: "0 -1px 3px rgba(0,0,0,0.07), 0 24px 24px rgba(0,0,0,0.03), 0 48px 48px rgba(0,0,0,0.06), 0 96px 96px rgba(0,0,0,0.07)",
